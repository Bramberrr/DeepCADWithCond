...
class ConfigAE(object):
    ...
    def set_configuration(self):
        ...
        self.cond_dim = 9 # volume, mass, wall_thickness, material
    ...
    def parse(self):
        ...
        parser.add_argument('--vis_frequency', type=int, default=3000, help="visualize output every x iterations")
